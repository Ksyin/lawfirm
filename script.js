...
(function () {
  ...
  function initChatbot() {
    ...
    const botReply = (message) => {
      ...
      return "Thank you for the information provided. A member of our legal team will be better placed to advise further. This conversation is already being shared with our team, and someone will follow up by email shortly.";
    };
    ...
    form.addEventListener("submit", (e) => {
      ...
      window.setTimeout(() => { addMessage(botReply(value)); scheduleTranscriptSend(); }, 250);
    });
    ...
    document.querySelectorAll(".chatbot-chip").forEach((chip) => {
      chip.addEventListener("click", () => {
        ...
        scheduleTranscriptSend();
        window.setTimeout(() => { addMessage(botReply(text)); scheduleTranscriptSend(); }, 250);
      });
    });
