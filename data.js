...
const TEAM = [
  ...
  },
  {
    ...
    credentials: "Legal Administrator & Secretary",
    focus: "Administrative & Client Support, Office Coordination",
    image: "Joyce M. Ambuga.jpeg",
    bio: [
      "Joyce M. Ambuga is a dedicated Legal Administrator and Secretary committed to maintaining high professional standards and supporting the efficient day-to-day operations of the firm. She provides reliable administrative and client support, ensuring that clients, advocates and other stakeholders receive courteous, responsive and professional assistance.",
      "With a strong focus on organisation, confidentiality and attention to detail, Joyce plays an important role in coordinating the firm's administrative functions and contributing to a professional and client-focused environment."
    ]
  },
  {
    name: "Advocate",
...
const CLIENTS = [
  { name: "Keysian Auctioneers", image: "keysian.png" },
  { name: "Fullback Communication & Marketing", image: "fullback.png" },
  { name: "Green Pot Enterprises", image: "greenpot.png" },
  { name: "Solvic Solutions", image: "solvic.png" },
  { name: "ProSolar", image: "prosolar.png" },
  { name: "Meridian Acceptances", image: "meridian.png" },
  { name: "Blue River Technology Solutions", image: "blueriver.png" },
  { name: "Ojowa Empire", image: "ojowa.png" },
  { name: "Kenya Basketball Federation", image: "kbf.png" },
  { name: "Rehema Holdings", image: "" }
];
