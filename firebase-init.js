/* ==========================================================================
   ...
   SDK scripts. The admin panel also needs auth + storage. This file only
   touches the Firebase products whose SDK script is actually present, so
   it works on both without erroring.
   ========================================================================== */
